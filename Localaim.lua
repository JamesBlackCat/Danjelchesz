...
RunService.Heartbeat:Connect(function(dt)
    ...
    if S.playerTPEnabled then
        ...
        if _playerTPAccum >= rate then
            _playerTPAccum = 0
            playerActiveTP = pickWeightedPart("playerTP")
        end
    else
        _playerTPAccum = 0
        playerActiveTP = nil
    ...
    if S.npcTPEnabled then
        ...
        if _npcTPAccum >= rate then
            _npcTPAccum = 0
            npcActiveTP = pickWeightedPart("npcTP")
        end
    else
        _npcTPAccum = 0
        npcActiveTP = nil
...
TBehav:CreateSection("PLR Row 1  (Part  |  Chance %)")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "e.g. UpperTorso",
    RemoveTextAfterFocusLost = false, Flag = "PlayerTP1Part",
    Callback = function(v) S.playerTP1Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.playerTP1Chance, Flag = "PlayerTP1Chance",
    Callback = function(v) S.playerTP1Chance = v end })
TBehav:CreateSection("PLR Row 2")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "e.g. Head",
    RemoveTextAfterFocusLost = false, Flag = "PlayerTP2Part",
    Callback = function(v) S.playerTP2Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.playerTP2Chance, Flag = "PlayerTP2Chance",
    Callback = function(v) S.playerTP2Chance = v end })
TBehav:CreateSection("PLR Row 3")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "PlayerTP3Part",
    Callback = function(v) S.playerTP3Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.playerTP3Chance, Flag = "PlayerTP3Chance",
    Callback = function(v) S.playerTP3Chance = v end })
TBehav:CreateSection("PLR Row 4")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "PlayerTP4Part",
    Callback = function(v) S.playerTP4Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.playerTP4Chance, Flag = "PlayerTP4Chance",
    Callback = function(v) S.playerTP4Chance = v end })
TBehav:CreateSection("PLR Row 5")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "PlayerTP5Part",
    Callback = function(v) S.playerTP5Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.playerTP5Chance, Flag = "PlayerTP5Chance",
    Callback = function(v) S.playerTP5Chance = v end })
TBehav:CreateSection("PLR Miss")
TBehav:CreateToggle({ Name = "Enable Miss  (aims purposely off-part)",
    CurrentValue = S.playerTPMiss, Flag = "PlayerTPMiss",
    Callback = function(v)
        S.playerTPMiss = v
        if v and S.aimlockMissChance == 0 then S.aimlockMissChance = 10 end
    end })
...
TBehav:CreateSection("NPC Row 1  (Part  |  Chance %)")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "e.g. UpperTorso",
    RemoveTextAfterFocusLost = false, Flag = "NpcTP1Part",
    Callback = function(v) S.npcTP1Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.npcTP1Chance, Flag = "NpcTP1Chance",
    Callback = function(v) S.npcTP1Chance = v end })
TBehav:CreateSection("NPC Row 2")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "e.g. Head",
    RemoveTextAfterFocusLost = false, Flag = "NpcTP2Part",
    Callback = function(v) S.npcTP2Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.npcTP2Chance, Flag = "NpcTP2Chance",
    Callback = function(v) S.npcTP2Chance = v end })
TBehav:CreateSection("NPC Row 3")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "NpcTP3Part",
    Callback = function(v) S.npcTP3Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.npcTP3Chance, Flag = "NpcTP3Chance",
    Callback = function(v) S.npcTP3Chance = v end })
TBehav:CreateSection("NPC Row 4")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "NpcTP4Part",
    Callback = function(v) S.npcTP4Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.npcTP4Chance, Flag = "NpcTP4Chance",
    Callback = function(v) S.npcTP4Chance = v end })
TBehav:CreateSection("NPC Row 5")
TBehav:CreateInput({ Name = "Part Name", PlaceholderText = "Leave blank to skip",
    RemoveTextAfterFocusLost = false, Flag = "NpcTP5Part",
    Callback = function(v) S.npcTP5Part = v or "" end })
TBehav:CreateSlider({ Name = "Chance %", Range = {0,100}, Increment = 1, Suffix = "%",
    CurrentValue = S.npcTP5Chance, Flag = "NpcTP5Chance",
    Callback = function(v) S.npcTP5Chance = v end })
